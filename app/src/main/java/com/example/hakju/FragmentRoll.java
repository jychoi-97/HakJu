...
public class FragmentRoll extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstFood.add(new Food("야채김밥\n1500원", "Categorie Food", "Description Food", R.drawable.gimbab));
        lstFood.add(new Food("라면\n2300원", "Categorie Food", "Description Food", R.drawable.ramyen));
        lstFood.add(new Food("불고기\n4800원", "Categorie Food", "Description Food", R.drawable.tukbul));
